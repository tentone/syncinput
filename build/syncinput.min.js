function SyncInput(){}VERSION="SyncInput V1.1";TIMESTAMP="201611230132";function Vector2(a,b){this.x=void 0!==a?a:0;this.y=void 0!==b?b:0}Vector2.prototype.set=function(a,b){this.x=a;this.y=b};function Key(){this.just_released=this.just_pressed=this.pressed=!1}Key.DOWN=-1;Key.UP=1;Key.RESET=0;Key.prototype.update=function(a){this.just_released=this.just_pressed=!1;a===Key.DOWN?(this.pressed||(this.just_pressed=!0),this.pressed=!0):a===Key.UP?(this.pressed&&(this.just_released=!0),this.pressed=!1):a===Key.RESET&&(this.just_pressed=this.just_released=!1)};Key.prototype.set=function(a,b,c){this.pressed=b;this.just_pressed=a;this.just_released=c};
Key.prototype.reset=function(){this.just_released=this.just_pressed=this.pressed=!1};function Mouse(){this._keys=[];this._position=new Vector2(0,0);this._position_updated=!1;this._delta=new Vector2(0,0);this._wheel=0;this._wheel_updated=!1;this.keys=[];this.position=new Vector2(0,0);this.delta=new Vector2(0,0);this.wheel=0;this.canvas=null;this.events=[];for(var a=0;3>a;a++)this._keys.push(new Key),this.keys.push(new Key);var b=this;void 0!==window.onmousewheel?this.events.push([window,"mousewheel",function(a){b._wheel=a.deltaY;b._wheel_updated=!0}]):void 0!==window.addEventListener?
this.events.push([window,"DOMMouseScroll",function(a){b._wheel=30*a.detail;b._wheel_updated=!0}]):this.events.push([window,"wheel",function(a){b._wheel=a.deltaY;b._wheel_updated=!0}]);if("ontouchstart"in window||0<navigator.msMaxTouchPoints){var c=new Vector2(0,0);this.events.push([window,"touchstart",function(a){a=a.touches[0];c.set(a.clientX,a.clientY);b.updateKey(Mouse.LEFT,Key.DOWN)}]);this.events.push([window,"touchend",function(a){b.updateKey(Mouse.LEFT,Key.UP)}]);this.events.push([window,"touchmove",
function(a){a=a.touches[0];if(null!==b.canvas){var e=b.canvas.getBoundingClientRect();b.updatePosition(a.clientX-e.left,a.clientY-e.top,a.clientX-c.x,a.clientY-c.y)}else b.updatePosition(a.clientX,a.clientY,a.clientX-c.x,a.clientY-c.y);c.set(a.clientX,a.clientY)}])}else this.events.push([window,"mousemove",function(a){if(null!==b.canvas){var c=b.canvas.getBoundingClientRect();b.updatePosition(a.clientX-c.left,a.clientY-c.top,a.movementX,a.movementY)}else b.updatePosition(a.clientX,a.clientY,a.movementX,
a.movementY)}]),this.events.push([window,"mousedown",function(a){b.updateKey(a.which-1,Key.DOWN)}]),this.events.push([window,"mouseup",function(a){b.updateKey(a.which-1,Key.UP)}]);for(a=0;a<this.events.length;a++){var d=this.events[a];d[0].addEventListener(d[1],d[2])}}Mouse.LEFT=0;Mouse.MIDDLE=1;Mouse.RIGHT=2;
...
Mouse.prototype.buttonJustPressed=function(a){return this.keys[a].just_pressed};Mouse.prototype.buttonJustReleased=function(a){return this.keys[a].just_released};Mouse.prototype.updatePosition=function(a,b,c,d){this._position.set(a,b);this._delta.x+=c;this._delta.y+=d;this._position_updated=!0};Mouse.prototype.updateKey=function(a,b){-1<a&&this._keys[a].update(b)};
Mouse.prototype.update=function(){for(var a=0;a<this._keys.length;a++)this._keys[a].just_pressed&&this.keys[a].just_pressed&&(this._keys[a].just_pressed=!1),this._keys[a].just_released&&this.keys[a].just_released&&(this._keys[a].just_released=!1),this.keys[a].set(this._keys[a].just_pressed,this._keys[a].pressed,this._keys[a].just_released);this._wheel_updated?(this.wheel=this._wheel,this._wheel_updated=!1):this.wheel=0;this._position_updated?(this.delta.x=this._delta.x,this.delta.y=this._delta.y,
this._delta.set(0,0),this.position.x=this._position.x,this.position.y=this._position.y,this._position_updated=!1):(this.delta.x=0,this.delta.y=0)};Mouse.prototype.dispose=function(){for(var a=0;a<this.events.length;a++){var b=this.events[a];b[0].removeEventListener(b[1],b[2])}};function Keyboard(){this.keys=[];this.actions=[];for(var a=0;256>a;a++)this.keys.push(new Key);this.events=[];var b=this.actions;this.events.push([window,"keydown",function(a){b.push(a.keyCode);b.push(Key.DOWN)}]);this.events.push([window,"keyup",function(a){b.push(a.keyCode);b.push(Key.UP)}]);for(a=0;a<this.events.length;a++){var c=this.events[a];c[0].addEventListener(c[1],c[2])}}
Keyboard.prototype.update=function(){for(var a=0;this.actions.length>a;){var b=this.actions.shift(),c=this.actions.shift();this.keys[b].update(c);if(this.keys[b].just_released||this.keys[b].just_pressed)this.actions.push(b),this.actions.push(Key.RESET),a+=2}};Keyboard.prototype.reset=function(){this.actions=[];for(var a=0;a<this.keys.length;a++)this.keys[a].reset()};Keyboard.prototype.keyPressed=function(a){return this.keys[a].pressed};Keyboard.prototype.keyJustPressed=function(a){return this.keys[a].just_pressed};
Keyboard.prototype.keyJustReleased=function(a){return this.keys[a].just_released};Keyboard.prototype.dispose=function(){for(var a=0;a<this.events.length;a++){var b=this.events[a];b[0].removeEventListener(b[1],b[2])}};Keyboard.TAB=9;Keyboard.ENTER=13;Keyboard.SHIFT=16;Keyboard.CTRL=17;Keyboard.ALT=18;Keyboard.CAPS_LOCK=20;Keyboard.ESC=27;Keyboard.SPACEBAR=32;Keyboard.PAGE_UP=33;Keyboard.PAGE_DOWN=34;Keyboard.END=35;Keyboard.HOME=36;Keyboard.INSERT=45;Keyboard.DEL=46;Keyboard.LEFT=37;
